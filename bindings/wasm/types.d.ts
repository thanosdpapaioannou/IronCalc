...
type ErrorType = "REF" | "NAME" | "VALUE" | "DIV" | "NA" | "NUM" | "ERROR" | "NIMPL" | "SPILL" | "CALC" | "CIRC";
type OpCompareType = "LessThan" | "GreaterThan" | "Equal" | "LessOrEqualThan" | "GreaterOrEqualThan" | "NonEqual";
...
export type TokenType = "Illegal" | "Eof" | {
    Ident: string;
} | {
    String: string;
} | {
...
} | "POWER" | "LPAREN" | "RPAREN" | "COLON" | "SEMICOLON" | "LBRACKET" | "RBRACKET" | "LBRACE" | "RBRACE" | "COMMA" | "BANG" | "PERCENT" | "AND" | Reference | Range;
...
export type HorizontalAlignment = "left" | "center" | "right" | "general" | "centerContinuous" | "distributed" | "fill" | "justify";
interface Alignment {
